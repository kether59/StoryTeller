                        ...
                        <div key={idx} style={{
                          ...
                          <div style={{ display: 'flex', alignItems: 'start', gap: 12 }}>
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              <textarea
                                  value={char.physicalDescription || char.physical_description || ''}
                                  onChange={(e) => updateItem('characters', idx, 'physicalDescription', e.target.value)}
